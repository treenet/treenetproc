...
All changes are flagged can be visually examined in the graphical outputs.
...
```{r Fig_1, fig.asp = 0.35, fig.retina = 2, echo = FALSE}
library(treenetproc)
data("dendro_data_L1")
data("dendro_data_L2")
...
```{r cite all dependencies, echo = TRUE, results="hide", message=FALSE, warning=FALSE}
# install.packages("devtools")
library(devtools)
