...
cap <- "**Figure 1** Time-alignment to a resolution of 10 minutes (top: 
`reso = 10`) and 60 minutes (bottom: `reso = 60`). Grey lines and circles
are the raw data, blue lines and points are the time-aligned data."
```
<br>
