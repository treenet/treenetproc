...
```{r processs to L2, fig.show="hide", fig.height=8, fig.width=6, message=FALSE, warning=FALSE, results="hide"}
...
```{r shrinking example code, results="hide", fig.show="hide", fig.height=8, fig.width=6, message = FALSE, warning = FALSE}
# load data
data("dendro_data_L1")
...
```{r shrinking example higher tol code, fig.show="hide", fig.height=8, fig.width=6, results="hide", message = FALSE, warning = FALSE}
# clean dendrometer data (default value of tol_jump and tol_out)
proc_dendro_L2(dendro_data = data_L1, tol_jump = 50, tol_out = 10, 
               plot_export = FALSE)
```

```{r shrinking example higher tol code #2, echo=FALSE, results = "hide", fig.show="hide", fig.height=8, fig.width=6, message = FALSE, warning = FALSE}
...
```{r frost no temp data_1, fig.show="hide", fig.height=8, fig.width=6, message=FALSE, warning=FALSE, results="hide"}
# load data
data("dendro_data_L1")
# subset data for example
data_L1 <- dendro_data_L1 %>% 
...
```{r frost with temp data_1, fig.show="hide", fig.height=8, fig.width=6, message=FALSE, warning=FALSE, results="hide"}
...
#### Data cleaning to L2
```{r corr_dendro_L3 example_1, results="hide", fig.width=6, fig.height=8, fig.retina=2, message=FALSE, warning=FALSE}
# load data
data("dendro_data_L1")
# subset data for example
data_L1 <- dendro_data_L1 %>% 
...
```{r corr_dendro_L3 example_3, results="hide", fig.width=6, fig.height=8, fig.retina=2, message=FALSE, warning=FALSE}
