...
example_L1 <- dendro_data_L1 %>% 
  dplyr::filter(series_id == "site-1_dendro-1") %>% 
...
named `series_id` to separate the sensors (long format, Table 1) or as separate 
...
dendro_data_L1 <- dendro_data_L1 %>% 
  filter(series_id == "site-1_dendro-1") %>% 
...
* **series_id**: name of the dendrometer series
...
# Subset dataset for example
dendro_L1 <- dendro_data_L1 %>% 
  filter(series_id == "site-1_dendro-3")
